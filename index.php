...
<head>
    <title>恶臭获利超</title>
    <meta itemprop="name" content="恶臭获利超" />
    <meta itemprop="description" content="致我终将逝去的青春" />
    <meta charset="utf-8" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        ...
        <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.reload()">主页</button>
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://ctm314423.github.io/Mr.Huo/'">开源</button>
        </div>
    </div>
    </div>
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">致我终将逝去的青春</div><br />
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="恶臭获利超">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
